...
<head>
    ...
    <title>Lentera Ilmu - Edit Profil</title>
...
<body>
    ...
    <main class="container">
        <a href="dashboard.php" class="back-link"><i class="fa-solid fa-arrow-left" style="margin-right: 6px;"></i> Kembali ke Beranda</a>
        ...
        <div class="profile-container">
            <div class="profile-card">
                ...
                <div class="profile-header">
                    ...
                    <h1 class="profile-title" id="profileName">Pengguna</h1>
                    <p class="profile-subtitle" id="profileEmail">user@email.com</p>
                </div>
                ...
                <form id="profileForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="institusi" placeholder="cth: Universitas Indraprasta PGRI">
                        </div>
                    </div>
    ...
    <script type="module">
        import {
            auth, db, cekLogin, updatePassword, updateEmail, reauthenticateWithCredential,
        ...
        cekLogin().then(async (user) => {
            ...
            const nama = userData.nama || firebaseUser.displayName || 'Pengguna';
            const email = firebaseUser.email || 'user@email.com';

            document.getElementById('profileName').textContent = nama;
            document.getElementById('profileEmail').textContent = email;
            document.getElementById('nama').value = userData.nama || '';
            document.getElementById('institusi').value = userData.institusi || '';
